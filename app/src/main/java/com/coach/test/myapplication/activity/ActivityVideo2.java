...
public class ActivityVideo2 extends WActivity
        implements IViewComment
{
    ...
    public static final String ACCPATH = "com.coach.test.myapplication.ACCPATH";
    public static final String HRPATH = "com.coach.test.myapplication.HRPATH";
    public static String FileName;

    private boolean setSave;


    public static String accTxtPath;
    public static String hrTxtPath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accTxtPath = intent.getStringExtra(ACCPATH);
        hrTxtPath = intent.getStringExtra(HRPATH);
        MwApiWrapper.WrapperVideoManager.initFileManager(accTxtPath,hrTxtPath);
        ...
        videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer player) {
                ...
                SoundPoolManager.playEnd(ActivityVideo2.this);
                closeActivity(RESULT_OK);
            }
        });

        if (m_progCode > 1) {
            //Log.i("ActivityVideo2","BluetoothManager.getCountGattClient()"+BluetoothManager.getCountGattClient());
            ...
            //else {
                ...
                if (m_isPlaying) {
                    ...
                    if (m_sec != pos) {
                        ...
                        //Log.i("ActivityVideo2","SetPosition: " + m_sec);
    ...
    void displayPoint(int value) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Log.i("ActivityVideo2","전체 퍼센테이지: " + arg);
    ...
    void displayCalorie(float value) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Log.i("ActivityVideo2","칼로리소비: " + arg);
    ...
    public void onInstruction(String s) {
        Log.i("ActivityVideo2","Instruction: " + s);
        displayDescription(s);
    }

    @Override
    public void onWarnning(String s) {
        Log.i("ActivityVideo2","Warnning: " + s);
        displayDescription(s);
    }
    ...
    public void onLaptime(String s) {
        Log.i("ActivityVideo2","Laptime: " + s);
        displayDescription(s);
    }
    ...
    public void onCommentR(String s) {
        Log.i("ActivityVideo2","CommentR: " + s);
        displayAccuracy(s);
    }

    @Override
    public void onDescription(int idx, String s) {
        Log.i("ActivityVideo2","Description: " + s);
        displayDescription(s);
    }

    @Override
    public void onBriefDescription(int idx, String s) {
        Log.i("ActivityVideo2","BriefDescription: " + s);
        displayTitle(s);
    }
}
